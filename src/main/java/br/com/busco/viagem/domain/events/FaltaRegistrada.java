...
@AllArgsConstructor
@NoArgsConstructor
public class FaltaRegistrada implements DomainEvent {
    @NotNull(message = "O parâmetro 'id' é obrigatório!")
    private PresencaId id;
    private Instant occurredOn;

    public static FaltaRegistrada from(Presenca presenca) {
        return new FaltaRegistrada(presenca.getId(), Instant.now());
    }
}
